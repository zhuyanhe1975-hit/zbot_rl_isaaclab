...
importlib.import_module("zbot_rl_isaaclab.tasks")
...
def main() -> None:
    ...
    parser.add_argument("--keyword", default="ZbotRlIsaaclab-", help="Substring used to filter task ids.")
    ...
    table.title = "Available zbot_rl_isaaclab Environments"
